...
from attention_only_transformer.two_layer_attn_transformer import TwoLayerTransformer
...
def get_config():
    ...
    C.system = CN()
    C.system.seed = 3457
    C.system.work_dir = 'out/artefacts_2'

    # model
    C.model = TwoLayerTransformer.get_default_config()
...
def train():
    ...
    model = TwoLayerTransformer(config.model)
